...
- **CA — la profondeur se règle** : le nombre de places d'un podium est un réglage, défaut **4** (la constante `PODIUM_JUSQU_AU` d'E06US004). Une profondeur < 1 est refusée : « ne rien récompenser » se dit en ne cochant aucune portée, pas en demandant zéro place. Une **seule** profondeur pour toutes les portées actives (arbitrage du 31/08/2026 : une profondeur par portée n'a pas de demandeur).
