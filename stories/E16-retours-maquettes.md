...
- **CA — récapitulatif repliable** de la journée, couvrant **tous les tours de toutes les phases** joués. *(Tranché : `<details>` natif, **ouvert par défaut**. P02 demande « repliable », pas « replié », et P03 veut les scores en direct — le livrer fermé aurait caché derrière un clic ce que la carte affichait déjà. Lecture **rétrospective** : les tours à venir en sont exclus, le bloc « Ensuite » d'E07US008 les porte déjà.)*
