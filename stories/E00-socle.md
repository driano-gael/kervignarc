...
- **CA — l'écrit confronté au code** : les chemins et symboles cités par les sections « Porté dans le code par » (25 ADR, 90 modules, 234 symboles) sont vérifiés contre le dépôt. Un chemin disparu est **bloquant** ; un symbole introuvable est un **signal** (l'extraction reste heuristique).
