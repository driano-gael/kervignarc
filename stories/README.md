...
| **E17US006** | Distinguer l'action destructrice de l'alerte | J3 | `DV-03` · ADR-0114 |
...
| **E17US007** | Résorber les écarts des écrans d'administration | J3 | ✅ **livrée le 25/09/2026** — A06 (panneau latéral) et A09 (recherche d'abord + compteurs) ; les quatre 🟠 découpés en `E17US012` |
| **E17US012** | Les écrans d'administration en carte-tableau (A04, A08, A12, A17) | J3 | ✅ **livrée le 26/09/2026** — colonnes des planches ; inscrits et cibles (A04), bandeau de totaux et ancienneté de la dette (A17, migration `0057`) ; colonnes sans donnée retirées des planches |
| **E17US011** | La ligne d'archer porte la volée en cours (S02) | J3 | ✅ **livrée le 25/09/2026** — volée en cours sur la ligne, case tapable, pavé ancré en bas ; `DETTE-111` résorbée pour la qualification |
