...
- **Absorbe** : ex-E09US001, E09US002. **Dépend de** : E00US012, E03US008 · **Jalon** : J1
...
- **Absorbe** : ex-E09US003, E09US004. **Dépend de** : E09US001, E03US008, E08US003 · **Jalon** : J1
...
- **Absorbe** : ex-E09US005, E09US006. **Dépend de** : E09US001, E06US008, E06US006 · **Jalon** : J3
...
- **CA** : **un QR par cible**, à poser sur le pied — il encode l'**URL de rattachement** du poste
  ...
  l'appareil photo capricieux) ; **un papier par scoreur** avec son code personnel (E10US008) ;
...
`stories/E03-placement.md` `E09US002/003`→`E09US001`/`E09US003` (inchangé pour 003) ;
`docs/fonctionnel/E01US010.md`, `docs/adr/0012-argent-en-centimes-entiers.md`,
`docs/adr/0014-club-inconnu-plutot-que-club-sentinelle.md` `E09US004`→`E09US003` ;
`stories/README.md` (numérotation historique du backlog 117 US) inchangée par construction, aucune
des références qu'il porte à `E09US001`…`E09US008` ne s'y trouve invalidée puisque E09US001,
E09US003 et E09US008 gardent leur identifiant.
