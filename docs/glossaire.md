...
| **Engagé** | `archer_engage` | Archer qui a **déjà tiré** (au moins un score). Le supprimer **efface ses flèches** : d'où un **signalement** (409) que l'admin confirme, comme l'homonyme — voir [ADR-0016](adr/0016-supprimer-un-archer-engage-plutot-que-le-refuser.md). Définition **datée** : elle s'élargira aux départs (E02US004) et aux duels. Ne pas confondre avec **Forfait** : un engagé qui *abandonne* ne se supprime pas. |
