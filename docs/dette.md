...
pour résoudre les identifiants à sa place. ⚠️ **Borné en revue** : la lecture n'a lieu que si la
portée `club` est réglée, or le défaut est *catégorie* seule — le cas courant ne paie donc rien.
