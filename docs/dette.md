...
deux sont défendables, et c'est un arbitrage à porter au commanditaire. À rattacher à `E05US034`, qui
rouvre déjà le registre d'avancement pour la qualification — donc qui paiera le patron une fois pour
deux formats.
...
### DETTE-054 — six paires de DTO jumeaux entre les deux routeurs de composition
