...
⚠️ **Pas un bloquant** : le déclencheur est un choix explicite de l'organisateur, et le défaut
...
`remboursement.creneau` ([ADR-0057](adr/0057-un-remboursement-est-un-poste-de-caisse.md)) pour
