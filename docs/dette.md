...
**Ce que fait le code.** `atlas/statique/` porte ~700 lignes de JavaScript navigateur (coquille,
...
seconde chaîne Node pour ~700 lignes sans build — les deux contredisent la règle 12 (« la rigueur
...
`atlas/statique/` dépasse ~1 000 lignes, ou si un défaut de rendu échappe **deux fois**. La sortie
