...
par le peuplement des phases (le point dur — il touche `ServiceSaisieDuels`, donc le déroulé réel du
jour J), porter les réglages dans `config.policies`, et rebrancher `classement.py` sur
