...
### DETTE-065 — le JavaScript de l'atlas n'est ni typé ni linté

**Ce que fait le code.** `atlas/statique/` porte ~1 050 lignes de JavaScript navigateur (coquille,
...
seconde chaîne Node pour ~1 050 lignes sans build — les deux contredisent la règle 12 (« la rigueur
