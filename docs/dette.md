...
`frontend/src/features/feu-vert/FeuVert.tsx` (marqueur `DETTE-090`).
...
placement 1→N lèvera la garde côté serveur, un front laissé en l'état annoncera une limite abolie,
