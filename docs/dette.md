...
⚠️ **Préjudice démontré le 20/09/2026 (E05US022), et il n'était jusque-là que théorique.**
...
décors décorrélés (`FauxDerouleRepository._sequence = 200`, `poser_phase_factice` impose
`identite_d_etape`), mais **la classe reste ouverte** : le prochain appelant refera l'erreur.
