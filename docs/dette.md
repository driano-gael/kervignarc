...
### DETTE-086 — la mise en page du plan de cibles n'a jamais été affichée

**Où** : `frontend/src/app/App.css`, section « Plan de cibles et plan de duels » (marqueur
`/* DETTE-086 */` en tête de section).
