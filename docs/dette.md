...
⚠️ **La recherche libre ne suit pas mécaniquement** : `presentation.ts` replie casse **et accents**
pour que « leguen » trouve « LE GUEN ». SQLite ne le fait pas sans colonne normalisée — c'est
