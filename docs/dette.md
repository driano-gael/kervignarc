...
introduire un sur pari. Le vrai motif est le périmètre : 33 entrées à déplacer dans un composant
de 500+ lignes, au milieu d'une US d'outillage documentaire.
