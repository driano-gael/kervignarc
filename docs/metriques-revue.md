...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-23 | `E17US010` | 10 | +264/−36 | ~21 min (14/14 vertes) | ~11 min | D (19:36→19:46) | majeur:4 mineur:1 suggestion:3 | majeur:1 mineur:7 | majeur:3 mineur:5 suggestion:3 | majeur:4 mineur:3 suggestion:2 | majeur:4 mineur:2 suggestion:1 | **aucun axe — promu par l'auteur au sabotage** (A-F3 = C1-3 = D-M3, rendus *majeur* par les trois) | 2 |
...
⚠️ **Enseignement d'`E17US010` : la colonne « bloquants par » peut dire « personne », et ce n'est
pas un axe qui a manqué.** Trois axes ont décrit le même défaut — le parseur du garde-fou jetait une
ligne qu'il ne savait pas lire — et l'ont classé **majeur**. Il était bloquant : un commentaire de
fin de ligne suffisait à rendre invisible le fantôme que l'US venait de retirer. Ce qui a tranché
n'est pas une relecture de plus mais **l'exécution du cas** : réintroduire la dérive et regarder la
suite rester verte. Un axe lit et qualifie ; l'auteur, lui, peut **essayer**. C'est un argument
pour que l'étape 2 rejoue par sabotage tout défaut décrit comme « le garde-fou ne mordrait pas »,
plutôt que d'arbitrer sa sévérité sur dossier — les trois trous de cette passe ont été fermés puis
**reprouvés** par la même méthode.
