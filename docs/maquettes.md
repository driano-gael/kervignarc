...
| Surface de validation : la planche `S08` n'a pas été suivie | `maquettes/s08-validation-cible.html` propose deux partis pris (validation **à la cible** / **à distance**, avec colonne « anomalie ») et un panneau « **Refus de validation** » — motif **obligatoire**, « le motif voyage avec le renvoi : le marqueur sait quoi reprendre », la tablette « affiche le motif et rouvre la saisie ». `E16US019` a livré une **troisième** forme : entrée par **archer** via le classement, une ligne par volée, sans cible, sans marqueur, sans anomalie — et surtout **sans motif** attaché au renvoi : la tablette apprend qu'on lui rend une volée, pas **pourquoi**. | Planche `S08`, relevée en revue d'E16US019 le 11/09/2026 | **À trancher** : le motif de renvoi est-il dû (US de suite), ou la forme livrée remplace-t-elle la planche ? ✅ La question ouverte de la planche — *« une validation peut-elle être annulée, et par qui ? »* — est, elle, **tranchée** : oui, par l'admin et le scoreur ([ADR-0109](adr/0109-une-volee-en-correction-reste-comptee.md)). |
