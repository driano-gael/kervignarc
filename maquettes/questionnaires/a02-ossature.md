# A02 · Ossature — trois axes de travail

> **Écran** : [A02 — Ossature — trois axes de travail](../a02-ossature.html) · **Appli** : Appli admin (`/admin`)
> **Appareil** : PC · 1600 × 900
> **Rôle** : Le découpage se fait par nature d'activité : pilotage, gestion, atelier. L'accueil de l'admin choisit l'axe.
>
> **Pas encore rempli.**

---

Ce fichier est un **talon**. Pour répondre, ouvre [la feuille de saisie](a02-ossature.html) dans un
...
telles quelles dans [`tour-1-2026-08-04/a02-ossature.md`](tour-1-2026-08-04/a02-ossature.md).
