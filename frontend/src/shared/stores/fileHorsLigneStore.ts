...
//
// Une saisie de volée ne doit être ni **perdue** ni bloquante : elle part dans cette file,
// persistée dans le `localStorage`, et se **rejoue à la reconnexion**. La persistance vaut jusqu'au
// bout — la file survit à la fermeture de l'onglet (D-05). Définie dans `shared/` pour que
// l'indicateur de connexion et la feature `saisie` en dépendent tous deux. ⚠️ Le **dédoublonnage
// est serveur** (ADR-0036), garanti tant que l'`identifiant_saisie` reste **stable au fil des
// rejeux** — d'où « on fige l'identifiant à la mise en file, jamais à chaque tentative ».
