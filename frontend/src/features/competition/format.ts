// Formatage partagé de l'**argent** — le tarif d'un départ (E02US004, ADR-0017).
//
...
// endroit où l'on convertit, dans un sens comme dans l'autre. Couvert par `format.test.ts`
// (E00US014) : l'aller-retour et le sens de complétion des décimales (`padEnd` vs `padStart`) sont
// testés — une régression qui fausserait le montant dû (EF-8.1) casse la CI.
