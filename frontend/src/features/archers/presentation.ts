...
// **répartir sous un titre lisible** et fournir le libellé d'un niveau — aucune règle métier, qui
// vit côté domaine Python (`domain/doublons.py`).
...
// Libellé lisible d'un niveau ; un niveau inconnu (serveur en avance sur le front) retombe sur son
// code brut plutôt que de disparaître silencieusement.
...
// les groupes **non vides** — un titre sans paire en dessous n'a rien à dire.
