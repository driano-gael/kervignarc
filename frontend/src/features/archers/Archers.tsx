...
// (E04US015 / ADR-0050, ex-E12US004), qui conserve ses résultats. Le message du serveur le dit ; c'est lui qu'on lit.
  ...
  return (
    <li>
      ...
      {/* `archer_engage` : un signalement, comme les deux autres — mais le seul dont la
          ...
          forfait (E04US015 / ADR-0050, ex-E12US004), pas une suppression — le lire est le geste utile ici. */}
      {engagementSignale ? (
