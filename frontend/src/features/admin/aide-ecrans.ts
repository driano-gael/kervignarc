...
export const AIDE_ECRANS: Record<DestinationAdminId, string> = {
  audit:
    'Le journal de ce qui a été fait sur ce tournoi : validations, corrections, forfaits, paiements — avec qui, quand, et l’ancienne valeur. C’est la pièce qui règle une contestation ; il se consulte pendant le tournoi, pas seulement après, et s’exporte au tableur.',
  tournoi:
  ...
  palmares:
    'Le classement final du tournoi : les podiums que vous avez réglés, puis le classement ' +
    'complet de tous les archers. Vous choisissez en haut ce que ce tournoi récompense — ' +
    'toutes catégories, par catégorie, par club — et sur combien de places ; le réglage vaut ' +
    'pour l’écran, l’affichage public et le PDF. Il se remplit au fil des duels — un rang ' +
    'affiché « 5ᵉ-8ᵉ » signifie que ' +
