...
export const AIDE_ECRANS: Record<DestinationAdminId, string> = {
  ...
  paiements:
    ...
    'chaque archer ; vous pointez ici les paiements reçus. Le bandeau du haut compte les archers ' +
    'restant à encaisser — c’est la complétude administrative, et elle n’empêche jamais de ' +
    'terminer le tournoi.',
  postes:
  ...
  completude:
    'Vérifiez ce qui reste à jouer avant de terminer le tournoi : cibles de qualification non ' +
    'terminées, phases, classement. Terminer fige le sportif — les inscriptions et les paiements, ' +
    'eux, se suivent sur l’axe Gestion et restent modifiables après.',
  classement:
