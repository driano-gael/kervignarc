...
> | **🎯 1** | reste d'`E16` | `E16US020` (hiérarchie de rôles — **ADR-0107 écrit** ; **état persisté requis** ; son CA de préséance s'appuie désormais sur la notion de volée rouverte d'[ADR-0109](../docs/adr/0109-une-volee-en-correction-reste-comptee.md)), `E16US021` (accueil par départ — **périmètre à borner avant de coder**), `E16US016` (reliquat d'exports — **arbitrage `xlsx`, règle 11**). **L'ordre entre les trois reste libre.** Deux membres de la famille « prêt à… » restent à instruire (*prêt à archiver*, *prêt à exporter*) — le second se rattache à `E16US016`. |
...
## Retours du questionnaire de maquettes (EPIC-16) — 🔶 **en cours (17/21)**
