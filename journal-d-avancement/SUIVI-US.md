...
**Dernière mise à jour : 22/08/2026, 14 h 35** · **121 US livrées** · dernière : `E05US027`
...
> | **🎯 1** | `E16US002` | **Écran « Phases » (A07), dernier des quatre écrans refusés.** ⚠️ **À recadrer avant d'être prise** — voir plus bas. ⚠️ **Et le recadrage a gagné en matière depuis** : cet écran porte désormais **cinq** fiches de réglages (poules, Big Shoot Off, suisse, colline, découpage) plus les arrêts programmés, là où le refus d'origine visait un écran qui n'en avait aucune. |
