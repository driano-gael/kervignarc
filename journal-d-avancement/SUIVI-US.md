...
**Dernière mise à jour : 12/09/2026, 18 h 47** · **139 US livrées** · dernière : `E16US021`
...
fassent autorité)*.
⚠️ **`E16US020` est livrée mais PAS mergée** : PR #182, ouverte le 12/09/2026 par une session
parallèle. Le compte ci-dessus est celui de **cette branche** (`main` + `E16US021`) ; si #182
fusionne d'abord, il passe à **140** — la ligne conflictera au merge, c'est le signal attendu.
...
> | **🎯 1** | reste d'`E16` | `E16US020` (hiérarchie de rôles — ⚠️ **livrée sur `feat/e16us020-hierarchie-de-roles`, PR #182 ouverte le 12/09/2026, en attente de merge** ; ne pas la reprendre), `E16US016` (reliquat d'exports — **arbitrage `xlsx`, règle 11**). Deux membres de la famille « prêt à… » restent à instruire (*prêt à archiver*, *prêt à exporter*) — le second se rattache à `E16US016`. |
