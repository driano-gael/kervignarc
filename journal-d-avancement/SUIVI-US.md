...
> | **🎯 1** | reste d'`E16` | `E16US007` (**à redécouper**), `E16US011` (**à découper**, deux contradictions à arbitrer), `E16US013` (**fiche neuve**, trois questions à trancher — candidate à un ADR) — **sans ordre imposé**. Deux membres de la famille « prêt à… » restent à instruire (*prêt à archiver*, *prêt à exporter*) — le second appartient naturellement à `E16US007`. ⚠️ **Une décision vous est demandée hors file** : ouvrir la route de forfait **en qualification** à l'organisateur (aujourd'hui scoreur seul), reliquat écrit d'`E16US010`. |
