...
**Dernière mise à jour : 25/09/2026, 20 h 42** · **149 US livrées** · dernière : `E17US011`
...
> | 🎯 **1** | `E17US007` | **Résorber les écarts relevés sur les écrans d'administration** — la dernière US d'`EPIC-17` prenable sans votre arbitrage. Le relevé date du 06/08 : ⚠️ **vérifier la correspondance questionnaire ↔ planche avant de mesurer** (ADR-0113), et ne pas traiter ce qui recoupe une E16 (A15, A18, A11). |
