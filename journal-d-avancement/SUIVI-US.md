...
| E16US014 | Podiums configurables | 31/08/2026 | ✅ *(trois portées **cumulables** — scratch · catégorie · club — et une profondeur réglable, sur les quatre surfaces du palmarès ; migration `0052`, défauts serveur = comportement d'E06US004. Coupée en deux au cadrage : les **clubs entre eux** → `E16US017`. Les équipes restent hors périmètre, EPIC-13)* |
| E16US017 | Le classement des clubs entre eux | — | ⬜ *(tranche B d'`E16US014`, 31/08/2026. Barème **tranché** : décompte de médailles (or, argent, bronze). ⚠️ Une question reste ouverte en Notes — un tournoi qui cumule *scratch* et *catégorie* décerne deux fois l'or au même archer)* |
