...
**Dernière mise à jour : 25/09/2026, 20 h 05** · **148 US livrées** · dernière : `E17US009`
...
> | 🎯 **1** | `E17US011` | **La ligne d'archer porte la volée en cours** (S02) — seul écart 🔴 laissé ouvert par `E17US008`, et porteur de la moitié « zone → points » de `DETTE-111`. Les deux écarts 🟠 de la tablette (largeur de la grille, touches à 90 px) se ferment avec elle. |
...
## Fidélité aux maquettes (EPIC-17) — 🔶 **en cours (7/11)**
