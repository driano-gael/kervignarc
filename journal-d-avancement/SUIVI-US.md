...
| ~~E17US007~~ | **Résorber** les écarts relevés sur les écrans d'administration | J3 | ✅ *(livrée le 25/09/2026 — **rétrécie** aux deux 🔴 : A06 liste + panneau latéral, A09 recherche d'abord + compteurs ; **non vue au navigateur**. `DETTE-114` ouverte)* |
