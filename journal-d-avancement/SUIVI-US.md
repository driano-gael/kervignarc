...
**Dernière mise à jour : 12/09/2026, 22 h 05** · **140 US livrées** · dernière : `E16US021`
...
> | **🎯 1** | `E16US016` | **Dernière d'`EPIC-16`** : reliquat d'exports — palmarès en tableur (renommage d'une **route publique**), écran de consultation du journal d'audit (la route existe, **aucun écran ne l'appelle**), et le format `xlsx` (**ajout de dépendance : arbitrage du commanditaire, règle 11**). Le membre *prêt à exporter* de la famille « prêt à… » s'y rattache ; *prêt à archiver* reste à instruire à part. |
