...
**Dernière mise à jour : 25/08/2026, 21 h 07** · **126 US livrées** · dernière : `E16US006`
> ⚠️ **126 fiches closes, mais 125 livraisons** : `E16US006` **absorbe** `E01US016`, et les deux
> passent à ✅ dans le même diff. Le compteur mécanique (règle de la Légende, recalculé par
> l'atlas) compte des **fiches**, pas des branches — c'est lui qui fait foi ici. Le noter plutôt
> que de forcer le chiffre : un compteur qu'on corrige à la main pour « avoir raison » est
> exactement ce que l'atlas existe pour empêcher.
...
le premier — fusion arbitrée au cadrage du 25/08. ⚠️ **Trois CA sur quatre de la fiche d'origine
étaient caducs ou déjà livrés**, constat fait dans le code : l'« origine FFTA / locale » est tenue
depuis `E01US023`, et les volets *clubs* et *barèmes* n'ont **aucun porteur** (un club n'est pas une
brique de patrimoine, un barème est un value object). ⚠️ **La dérivation a un oracle externe** : la
charte avait décliné le rouge du club **à la main** en E17US001 ; le calcul la reproduit — exactement
sur le contour, à **un cran près** sur le texte, écart instruit. Migration `0050`,
...
> | **🎯 1** | reste d'`E16` | `E16US008`, `E16US009`, `E16US010`, `E16US007` (**à redécouper**), `E16US011` (**à découper**, deux contradictions à arbitrer) — **sans ordre imposé**. Deux membres de la famille « prêt à… » restent à instruire (*prêt à archiver*, *prêt à exporter*) — le second appartient naturellement à `E16US007`. ✅ **La dépendance d'`E16US009` est levée** : son CA « logo » est livré par `E16US006`, il ne lui reste que la **durée de page réglable** et le **défilement sous la tête figée**. |
