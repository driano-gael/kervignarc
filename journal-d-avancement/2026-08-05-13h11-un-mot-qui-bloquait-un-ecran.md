# 5 août 2026, 13h11 — Un seul mot bloquait un écran

L'écran de **plan de salle** avait été refusé à la relecture des maquettes. Pas pour un défaut de
conception : pour un mot. Le logiciel appelait « **pas de tir** » une rangée de cibles et
« **poste** » la place d'un archer devant sa cible. Deux mots pour deux idées — mais pas les bonnes,
...
- un **poste** reste une **tablette ou un écran**, jamais la place d'un archer.
...
représente — et c'était bien tout ce qui lui manquait.
