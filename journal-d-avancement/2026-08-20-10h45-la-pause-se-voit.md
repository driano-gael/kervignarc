# 20/08/2026, 10 h 45 — la pause se voit, et se pose en cours de journée

**US livrée : `E05US034`** (tranche B du découpage d'`E05US033`)

Hier, l'application a appris à **arrêter la salle** : on programme ses pauses à l'atelier, la salle
s'éteint toute seule au tour prévu, un bouton la relance. Il lui manquait de le **dire**.

Une compétition immobile et un écran muet, vus des gradins, ressemblent exactement à une panne. Et
l'organisateur ne découvrait qu'une phase attendait sa relance qu'en ouvrant l'écran de pilotage —
donc, potentiellement, un quart d'heure trop tard. C'était l'angle mort assumé de la tranche
précédente, et la raison pour laquelle elle ne devait pas servir un jour de compétition avant
celle-ci.
...
- **l'organisateur pose une pause sans l'avoir prévue** : « bloquer dans 2 tours », depuis le
  pilotage, pendant que la salle tire ;
...
et que *tous* les créneaux rejouent : une panne de chauffage à 14 h n'a aucune raison d'arrêter le
départ du soir.

**Ce qui reste à faire.** La **qualification** ne peut toujours pas porter de pause : elle ne compte
qu'un seul tour, donc un arrêt « après le tour n » n'a nulle part où se poser. La rendre divisible
