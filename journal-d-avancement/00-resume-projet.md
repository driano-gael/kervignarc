...
répond surtout à une question qui n'en avait pas : **82 des 83 décisions d'architecture portent la
mention « Accepté »** et une seule est marquée « remplacée », alors que **19 ont été amendées** par
une décision plus récente — information qui ne figurait sur aucune des fiches concernées. L'atlas la
calcule, et confronte au passage les **234 fonctions et classes** que ces décisions promettent au
code réellement présent. Ce n'est pas une documentation de plus à tenir : tout y est **regénéré
